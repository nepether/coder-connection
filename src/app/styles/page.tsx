...
export default function Home() {
  return (
    <main className="space-y-8 px-10">
      ...
      <Large>
        Paragraph Large: The king, seeing how much happier his subjects were,
        realized the error of his ways and repealed the joke tax.{" "}
      </Large>
      <Paragraph>
        Paragraph Normal: The king, seeing how much happier his subjects were,
        realized the error of his ways and repealed the joke tax.
        <br />
        <Small className="text-slate-600">
          Paragraph Small: The king, seeing how much happier his subjects were,
          realized the error of his ways and repealed the joke tax.
        </Small>
      </Paragraph>
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button variant="outline">Tootip on Hover</Button>
          </TooltipTrigger>
          <TooltipContent>
            <p>Tooltip example: Add to library</p>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
